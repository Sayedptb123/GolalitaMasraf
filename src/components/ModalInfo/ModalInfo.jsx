    ...
    <Modal transparent={true} onDismiss={onCancel}>
      <View style={styles.modalView}>
        <View style={styles.modal}>
          {isSuccess && (
            <View style={[mainStyles.centeredRow, { marginBottom: 15 }]}>
              <SuccessIcon />
            </View>
          )}
          <TypographyText
          ...
          <View
            style={isSuccess ? mainStyles.centeredRow : mainStyles.betweenRow}
          >
            {!isSuccess && (
              <TouchableOpacity
                onPress={onCancel}
                style={[styles.modal__button, { backgroundColor: "#E7EAF1" }]}
              >
                <TypographyText
                  textColor={colors.darkBlue}
                  size={14}
            ...
            <TouchableOpacity
              onPress={onSubmit}
              style={[styles.modal__button, { backgroundColor: colors.orange }]}
            >
              <TypographyText
