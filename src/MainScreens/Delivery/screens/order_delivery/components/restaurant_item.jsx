...
const RestaurantItem = ({ restaurnts, getRestaurants, navigation }) => {
  //function RestaurantItem({navigation}) {
  //const {restaurnts} = useSelector(state => state.restaurntReducer);
  useEffect(() => {
    getRestaurants();
  }, []);
  //console.log(restaurnts);
  //const restaurnts = useSelector((state) => state.restaurntReducer)
  const tst = ModeTest();
...
export default connect(mapStateToProps, { getRestaurants })(RestaurantItem);
